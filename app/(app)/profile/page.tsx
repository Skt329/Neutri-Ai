...
export const metadata = {
  title: "Profile & Settings — NutriAI",
  description: "Manage your body metrics, dietary preferences, account settings, and daily nutrition targets.",
}
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-forest rounded-2xl p-6 text-white animate-fade-in-up">
          <div className="flex items-center gap-4 mb-4">
            <div className="flex size-16 items-center justify-center rounded-full bg-white/10 text-2xl font-display font-bold ring-2 ring-white/20">
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 md:py-8">
      ...
      <div className="mb-6 animate-fade-in-up">
        ...
        <p className="text-stone text-sm mt-1">Your metrics, preferences, and account settings.</p>
      </div>
